...
// Check if the user is signed in
    ...
    await FirebaseFirestore.instance.collection('customer').doc(currentUser!.uid).collection("user_location").add({
...
Future<void> getCurrentLocation() async {
  try {
    ...
    await findAndPrintNearestServiceStation(currentPosition.latitude, currentPosition.latitude);
  } catch (e) {
    print("Error getting current location: $e");
  }
}

Future<void> findAndPrintNearestServiceStation(double userLatitude, double userLongitude) async {
  try {
    ...
    ServiceStation nearestStation = findNearestServiceStation(userLatitude, userLongitude, serviceStations);
...
ServiceStation findNearestServiceStation(double userLatitude, double userLongitude, List<ServiceStation> serviceStations) {
